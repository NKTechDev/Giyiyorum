...
const VideoPage = () => {
    ...
    const [favourite, setFavurites] = useState(false)
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/api/v1/video/category/${categoryName}`);
                console.log('category video fetch', response)
    ...
    }, [categoryName, userLikeColor, userDislikeColor, comments, favourite]);
    ...
    if (videos.length < 0) {
        return (
            <Box display="flex" justifyContent="center" alignItems="center" height="100vh">
                <Typography variant="h6" color="black" align="center">{backendError}</Typography>
            </Box>
        );
    }
    ...
    return (
        <>
            ...
            <Box >
                ...
                <Grid container sx={{ backgroundColor: 'white' }} direction="column" justifyContent="center">
                    ...
                    {videos.length > 0 ? (
                            ...
                            return (
                                <Grid item xs={12} key={video._id} sx={{ display: 'flex', justifyContent: 'center' }}>
                                    <Card sx={{
                                        ...
                                        maxWidth: '800px',
                                        height: '80vh',
                                        marginBottom: { xs: '10px', md: '10px' }, // Smaller margin on mobile
                                        display: 'flex',
                                        flexDirection: { xs: 'row', md: 'row' }, // Always row, even on mobile
                                        alignItems: 'center', // Align items vertically
                                        padding: { xs: '3px', md: '5px' }, // Smaller padding on mobile
                                        ...
                                        <Box sx={{
                                            ...
                                            flex: 1,
                                            padding: { xs: '4px', md: '4px' } // Smaller padding on mobile
                                        }}>
                                            <Box sx={{
                                                position: 'relative',
                                                width: '100%',
                                        ...
                                        <Box sx={{
                                            ...
                                            >
                                                <ThumbUpIcon sx={{ color: 'black', fontSize: { xs: '0.8rem', md: '1rem' } }} />
                                                <Typography variant="caption" color="black" sx={{ fontSize: { xs: '10px', md: '12px' } }}>
                                                    {totalLikes}
                                                </Typography>
                                            </IconButton>
                                            ...
                                            >
                                                <ThumbDownIcon sx={{ color: 'black', fontSize: { xs: '0.8rem', md: '1rem' } }} />
                                                <Typography variant="caption" color="black" sx={{ fontSize: { xs: '10px', md: '12px' } }}>
                                                    {totalDislikes}
                                                </Typography>
                                            </IconButton>
                                            ...
                                            >
                                                <ChatBubbleIcon sx={{ color: 'black', fontSize: { xs: '0.8rem', md: '1rem' } }} />
                                                <Typography variant="caption" color="black" sx={{ fontSize: { xs: '10px', md: '12px' } }}>
                                            ...
                                            >
                                                <FavoriteIcon sx={{ color: 'black', fontSize: '1rem' }} />
                                                <Typography variant="caption" color="black" sx={{ fontSize: { xs: '10px', md: '12px' } }}>
                                            ...
                                            >
                                                <ShareIcon sx={{ color: 'black', fontSize: { xs: '0.8rem', md: '1rem' } }} />
                                                <Typography variant="caption" color="black" sx={{ fontSize: { xs: '10px', md: '12px' } }}>
                                                </Typography>
                                            </IconButton>
                        ...
                        <Box display="flex" justifyContent="center" alignItems="center" minHeight="50vh">
                            <Typography variant="h6" color="black" align="center" sx={{ fontSize: { xs: '14px', md: '18px' } }}>
...
{/* <Box sx={{
    ...
    width: { xs: '15px', md: '48px' }, 
}}>
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: { xs: 1, md: 2 } }}>
        <Typography variant="subtitle2" color="white" sx={{ marginBottom: { xs: 0.5, md: 1 }, fontSize: { xs: '10px', md: '14px' } }}> {/* Smaller font size on mobile */}
// Like
//     </Typography>
//     {video.likeColors.map((likeColor) => (
//         <Box key={likeColor._id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: { xs: 0.5, md: 1 } }}>
//             <Box sx={{ width: { xs: '15px', md: '10px' }, height: { xs: '15px', md: '10px' }, backgroundColor: likeColor.color, borderRadius: '50%' }} /> {/* Smaller circle on mobile */}
//             <Typography variant="caption" color="white" sx={{ fontSize: { xs: '10px', md: '12px' } }}>{likeColor.count}</Typography> {/* Smaller font size on mobile */}
//         </Box>
//     ))}
// </Box>
...
//         Dislike
//     </Typography>
//     {video.dislikeColors.map((dislikeColor) => (
//         <Box key={dislikeColor._id} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: { xs: 0.5, md: 1 } }}>
//             <Box sx={{ width: { xs: '15px', md: '10px' }, height: { xs: '15px', md: '10px' }, backgroundColor: dislikeColor.color, borderRadius: '50%' }} /> {/* Smaller circle on mobile */}
//             <Typography variant="caption" color="white" sx={{ fontSize: { xs: '10px', md: '12px' } }}>{dislikeColor.count}</Typography> {/* Smaller font size on mobile */}
//         </Box>
//     ))}
// </Box>
// </Box> */}